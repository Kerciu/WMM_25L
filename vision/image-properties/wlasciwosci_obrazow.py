...
if __name__ == '__main__':
    ...
    image = cv2.imread("image-properties\\monochrome\\susie_mono.png", cv2.IMREAD_UNCHANGED)
    printi(image, "image")
    ...
    """
    bitrate = 8*os.stat(".\\image-properties\\monochrome\\susie_mono.png").st_size/(image.shape[0]*image.shape[1])
    ...
    image_col = cv2.imread(".\\image-properties\\monochrome\\lena_mono.png")
